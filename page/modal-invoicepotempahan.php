    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">INVOICE | <a href="Poinvoice.php?Kode=<?php echo $result['Kode']; ?>" target="_BLANK" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> Cetak</a></h5>
                            ...
                            <table width="1033" border="0">
                                ...
                                <tr>
                                    ...
                                    <td width="204">
                                        ...
                                        $biaya = $nah - $result['Panjar'];

                                        // echo $Hsatuan;
                                        echo $hasil_rupiah = "Rp " . number_format($biaya, 2, ',', '.');
                                        ?>
                                    </td>
                                </tr>
                            </table>
