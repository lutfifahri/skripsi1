    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel"><a href="spkserviceprint.php?Kode=<?php echo $result['Kode']; ?>" target="_BLANK" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> Cetak</a></h5>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div align="center"><strong>
                                                <h3>SURAT PERINTAH KERJA SERVICE / REPARASI </h3>
                                            </strong></div>
                                    </td>
                                </tr>
                                <tr>
