...
<div class="col-12">
    <div class="card">
        ...
        <div class="modal-body">
            <form action="LaporanProduksi.php" target="_blank" method="GET" autocomplete="off" id="" style="margin-bottom:0px">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    ...
                    <div class="col-sm-9">
                        <select name="Kode" id="Kode" class="form-control">
                            ...
                            <?php
                            include '../koneksi.php';
                            $query = mysqli_query($koneksi, "SELECT * FROM `poproduksi` WHERE Tipe!='Z' ");
