...
<div id="content">
    ...
    include '../koneksi.php';
    $iduser = $_GET['id'];
    $query = mysqli_query($koneksi, "SELECT * FROM `user` WHERE iduser='$iduser' AND Tipe!='Z' ") or die(mysqli_error($koneksi));
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Ubah Anggota</h5>
