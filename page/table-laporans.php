...
<div class="col-12">
    <div class="card">
        ...
        <div class="modal-body">
            <form action="LaporanService.php" target="_blank" method="GET" autocomplete="off" id="formAdd" style="margin-bottom:0px">
                ...
                <div class="form-group row" style="margin-bottom:8px">
                    <label for="" class="col-sm-3 col-form-label">Purchase Order Produksi</label>
                    <div class="col-sm-9">
                        <select name="Kode" id="Kode" class="form-control">
                            <option value="">--Pilih--</option>
                            <?php
                            include '../koneksi.php';
                            $query = mysqli_query($koneksi, "SELECT * FROM `poservice` WHERE Tipe!='Z' ");
