        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Ubah Password</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Data Ubah Password</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'service_user.php?action=edit',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        if (data == 1) {
                            ...
                            Toast.fire({
                                type: 'error',
                                title: 'Maaf  Confirmasi Password Baru Tidak Sesuai !',
                            })
                            return false;
                        } else if (data == 2) {
                            const Toast = Swal.mixin({
                            ...
                            Toast.fire({
                                type: 'error',
                                title: 'Maaf password lama tidak sesuai !',
                            })
                            return false;
                        } else {
                            const Toast = Swal.mixin({
