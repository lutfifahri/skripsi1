                    ...
                    ?>
                        <tr>
                            ...
                            <?php if ($_SESSION['SES_Level'] == '1') { ?>
                                ...
                                if ($a['Status'] == '1') {
                                        echo '<button class="btn btn-sm btn-primary" disabled="disabled">Di Proses ... <i class="fas fa-spinner"></i></button>';
                                } elseif ($a['Status'] == '2') {
                                    echo '<button class="btn btn-sm btn-success" disabled="disabled">Selesai &nbsp;&nbsp;&nbsp;&nbsp;... <i class="fas fa-check-square"></i></button>';
                                } 
                            ?></td>
                            <?php } ?>
                            <?php if ($_SESSION['SES_Level'] == '2') { ?>
                                <td style="padding-top:0; padding-bottom:0; vertical-align: middle"><?php 
                                if ($a['Status'] == '1') {
                                        echo '<button id="DeleteButton1" value="' . $a['id'] . '" class="btn btn-sm btn-primary">Pengambilan Barang</button>';
                                } elseif ($a['Status'] == '2') {
                                    echo '<button class="btn btn-sm btn-success" disabled="disabled">Selesai &nbsp;&nbsp;&nbsp;&nbsp;... <i class="fas fa-check-square"></i></button>';
                                } 
                            ?></td>
