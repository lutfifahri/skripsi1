...
<div id="content">
    ...
    include '../koneksi.php';
    $id = $_GET['id'];
    $query = mysqli_query($koneksi, "SELECT * FROM `poservice` WHERE id='$id' AND Tipe!='Z' ") or die(mysqli_error($koneksi));
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Ubah Purchase Order Service / Reparasi</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" style="margin-bottom:8px">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="hidden" name="" id="HargaKrumCek" class="form-control" value="890.000">
                                        </div>
                                        <div class="col-sm-3">
                                            <textarea name="KeteranganKrum" id="" cols="1" rows="1" class="form-control"><?php echo $result['KeteranganKrum'] ?></textarea>
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="number" name="HargaKrum" id="hasilnya" class="form-control" value="<?php echo $result['HargaKrum'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row" style="margin-bottom:8px">
