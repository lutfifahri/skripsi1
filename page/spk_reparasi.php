...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Surat Perintah Kerja Service / Reparasi</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Surat Perintah Kerja Service / Reparasi</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
 ...
 //hapus data  berdasarkan id
        $("#contentData").on("click", "#DeleteButton1", function() {
                ...
                // alert(id);
                $.ajax({
                    url: 'service_spkservice.php?action=edit',
                    type: 'post',
                    data: {
                        id: id
                    },
                    success: function(data) {
                        if (data == 'success') {
                            ...
                            Toast.fire({
                                ...
                                .then(function() {
                                    // location.reload();
                                    $('#contentData').load("table-spkservice.php");
                                });
                        }
                    }
                });
